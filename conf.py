...
project = 'Petlja - Информатика и рачунарство за пети разред'
...
html_context = {'course_id': 'Информатика и рачунарство за пети разред',
                ...
                'basecourse': 'Информатика и рачунарство за пети разред',
...
html_theme_options = {
    ...
    'navbar_title': "Petlja - Информатика и рачунарство за пети разред",
...
html_title = 'Petlja - Информатика и рачунарство за пети разред'

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title ='Petlja - Информатика и рачунарство за пети разред'
...
htmlhelp_basename = 'Информатика и рачунарство за пети разред-doc'
